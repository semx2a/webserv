...
ServerContext::ServerContext() : _autoindex("off"), _maxBodySize(1048576) {
...
std::vector<std::string> const &			ServerContext::getLimitExcept(void) const { return this->_limitExcept; }
...
void	ServerContext::setLimitExcept(std::vector<std::string> const& limitExcept) { this->_limitExcept = limitExcept; }
